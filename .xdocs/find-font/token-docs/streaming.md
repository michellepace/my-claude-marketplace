...
description: Learn how to stream responses incrementally with server-sent events, handle event types and content block deltas, and accumulate them into a final Message using the Claude SDKs.
source:
  scraped_url: https://platform.claude.com/docs/en/build-with-claude/streaming.md
