...
| `shadcn-ui` | 1 skill | shadcn/ui best practices (Radix UI + Tailwind) |
| `cc-whats-new` | 1 command | Explain Claude Code release changes |
| `cc-what-plugins` | 1 command | Show enabled plugins across all scopes |
