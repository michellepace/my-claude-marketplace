---
title: Pricing
description: This page provides detailed pricing information for Anthropic's models and features. All prices are in USD.
source:
  scraped_url: https://platform.claude.com/docs/en/about-claude/pricing.md
