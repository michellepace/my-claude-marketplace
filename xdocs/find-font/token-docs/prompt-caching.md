...
description:
source:
  scraped_url: https://platform.claude.com/docs/en/build-with-claude/prompt-caching.md
  canonical_url: https://platform.claude.com/docs/en/build-with-claude/prompt-caching
